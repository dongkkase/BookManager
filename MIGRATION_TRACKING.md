...
- [x] 탐색기/리스트/상세 패널 크기 조절, 보기 모드별 항목 크기 조절, 단축키, 우클릭 컨텍스트 메뉴 연동
- [x] 공통 상단 툴바의 폴더 추가/파일 추가/선택 삭제/전체 비우기/전체 선택 액션 연동
...
- [x] 공통 상단 툴바의 파일/폴더 추가, 체크 항목 삭제, 전체 비우기, 전체 선택/해제 액션 연동
...
- [x] API 검색 결과 다이얼로그 및 리디북스/알라딘/Google Books/Anilist/Comic Vine 외부 API fetch 마이그레이션
- [x] 라이브러리 최신권 메타 불러오기 및 파일명 기반 자동 제목/권수/화/페이지 입력 마이그레이션
- [x] 공통 상단 툴바의 파일/폴더 추가, 체크 항목 삭제, 전체 비우기, 전체 선택/해제 액션 연동
...
- [x] 공유 탭의 URL 복사/비밀번호 보기/서버 토글 UI를 폰트어썸 아이콘 기반으로 정리
