            ...
            try:
                ...
                with tempfile.TemporaryDirectory() as temp_dir:
                    ...
                    extracted_cover = os.path.join(
                        temp_dir, os.path.basename(cover_path_in_archive)
                    )
                    thumb_filename = (
                        hashlib.md5(fp.encode("utf-8")).hexdigest()
                        + os.path.splitext(cover_path_in_archive)[1]
                    )
