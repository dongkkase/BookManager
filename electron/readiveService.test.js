...
test('Readive pairing consumes short-lived tickets and authenticates every LAN route', async t => {
    ...
    await assert.rejects(service.dispatch(args), /invalid_pairing_ticket/);
