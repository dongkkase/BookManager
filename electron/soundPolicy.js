        ...
        return {
            ...
            args: [
                ...
                [
                    ...
                    '$player.Play()',
                    '$duration = 2500',
                    'for ($i = 0; $i -lt 30 -and -not $player.NaturalDuration.HasTimeSpan; $i++) { Start-Sleep -Milliseconds 100 }',
                    'if ($player.NaturalDuration.HasTimeSpan) { $duration = [Math]::Max(500, [int]$player.NaturalDuration.TimeSpan.TotalMilliseconds + 200) }',
